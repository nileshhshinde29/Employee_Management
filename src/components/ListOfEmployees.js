    ...
    <>
      ...
      >
        {/* <Typography variant="h4" sx={{fontFamily: 'serif', fontWeight: 'bold'}} component='u'> */}
          {/* List of Employees - */}
        {/* </Typography> */}
        {/* <Box p={1} component='m' ml={80} border={1}  sx={{textOverflow:'clip'}}>
          list of employee
        </Box> */}
        ...
        <Button  variant="outlined" color="success" onClick={() => navigate('/employees/add')}>
          Add Employee
        </Button>
              ...
              <TableBody>
                {data.map((row) => (
                  ...
                  >
                    ...
                    <TableCell>
                          <Link m={10} to={'/employees/update'} state= {row}><Tooltip title="Edit" placement='left-start'><EditRoundedIcon color='#eceff1' /></Tooltip></Link>
                      
                         <Link to={''} onClick={() => confirmDelete(row)}><Tooltip title="Delete" placement='right-start'><DeleteRoundedIcon color='' /></Tooltip></Link>
